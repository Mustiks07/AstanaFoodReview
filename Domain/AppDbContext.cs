    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Restaurant>().HasData(
            ...
            new Restaurant
            {
                ...
                Address = "ул. Иманбаева, 10",
                Phone = "+7 (717) 231-00-11",
            ...
            new Restaurant
            {
                ...
                Address = "ул. Жубанова, 3",
                Phone = "+7 (717) 245-33-44",
            ...
            new Restaurant
            {
                ...
                Address = "пр. Республики, 1, ТРЦ Мега",
                Phone = "+7 (800) 080-08-08",
            ...
            new Restaurant
            {
                ...
                Address = "ул. Аманжолова, 9",
                Phone = "+7 (717) 225-99-00",
            ...
            new Restaurant
            {
                ...
                Address = "ул. Иманова, 18",
                Phone = "+7 (717) 256-11-22",
            ...
            new Restaurant
            {
                ...
                Address = "ул. Бейбітшілік, 55",
                Phone = "+7 (717) 267-22-33",
            ...
            new Restaurant
            {
                ...
                Address = "пр. Мәңгілік Ел, 60, Expo",
                Phone = "+7 (717) 300-00-01",
            ...
            {
                Id = 12, Title = "Coffee Lab",
                Description = "Лаборатория кофе: эспрессо, фильтр, колд-брю. Бариста-чемпионы и авторские сезонные напитки.",
                Address = "ул. Кенесары, 40",
                Phone = "+7 (717) 212-55-66",
                PriceRange = PriceRangeEnum.Budget,
                IsVerified = true,
            ...
            {
                Id = 14, Title = "Пекинская утка",
                Description = "Специализируемся на утке по-пекински. Также лапша вок, пельмени цзяоцзы и чай пуэр.",
                Address = "пр. Абая, 15",
                Phone = "+7 (717) 278-77-88",
                PriceRange = PriceRangeEnum.Medium,
                IsVerified = false,
            ...
            {
                Id = 15, Title = "Le Bistro",
                Description = "Европейская кухня в классическом стиле: телятина, лосось, крем-брюле. Бизнес-ланч каждый день.",
                Address = "пр. Кабанбай батыра, 58",
                Phone = "+7 (717) 291-88-99",
                PriceRange = PriceRangeEnum.Premium,
                IsVerified = true,
            ...
            {
                Id = 17, Title = "Астана Гриль",
                Description = "Казахский гриль и мангал: рёбрышки, бараньи отбивные, шашлык. Открытая терраса летом.",
                Address = "ул. Аманжолова, 9",
                Phone = "+7 (717) 225-99-00",
                PriceRange = PriceRangeEnum.Medium,
                IsVerified = false,
